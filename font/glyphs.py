...
if len(args) == 2 and args[0] == "-test":
    ...
    f.write("  47 150 .staccato\n")
    f.write("  grestore 67 hm} def\n")
    f.write("/.tbreve {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  306 150 .breve\n")
    f.write("  grestore 326 hm} def\n")
    f.write("/.tsemibreve {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  207 150 .semibreve\n")
    f.write("  grestore 227 hm} def\n")
    f.write("/.tminim {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  150 150 .headminim\n")
    f.write("  24 setlinewidth newpath 286 187 moveto 850 vl stroke\n")
    f.write("  grestore 170 hm} def\n")
    f.write("/.tcrotchet {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  149 150 .headcrotchet\n")
    f.write("  24 setlinewidth newpath 286 200 moveto 850 vl stroke\n")
    f.write("  grestore 170 hm} def\n")
    f.write("/.tquaver {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  149 150 .headcrotchet\n")
    f.write("  24 setlinewidth newpath 286 200 moveto 850 vl stroke\n")
    f.write("  286 1050 .tailquaverup\n")
    f.write("  grestore 307 hm} def\n")
    f.write("/.tsemiquaver {gsave\n")
    f.write("  currentpoint translate 0.5 dup scale\n")
    f.write("  149 150 .headcrotchet\n")
    f.write("  24 setlinewidth newpath 286 200 moveto 850 vl stroke\n")
    f.write("  286 1050 .tailquaverup\n")
    f.write("  286 900 .tailquaverup\n")
    f.write("  grestore 307 hm} def\n")
    ...
    glyphlist = [
    ("accent",       "scripts.sforzato",       0xe15b, 0.5,0.5, 1,0.5),
    ("espressivo",   "scripts.espr",           0xe15c, 0.5,0.5, 1,0.5),
    ("accslashbigup", "flags.ugrace",          0xe18e, 'ox','oy', 1,'oy'),
    ("accslashbigdn", "flags.dgrace",          0xe18f, 'ox','oy', 1,'oy'),
    ("acclparen",    "accidentals.leftparen",  0xe118, 1,0.5, 1,0.5, {"x1":"rx"}),
    ("accrparen",    "accidentals.rightparen", 0xe117, 0,0.5, 1,0.5, {"x0":"lx"}),
    ("arpeggioshort", "scripts.arpeggio",      0xe178, 0,'oy', 1,'oy', {"x0":"lx","x1":"rx","y0":"oy","y1":"ty"}),
    ...
    ("bowdown",      "scripts.downbow",        0xe168, 0.5,0, 1,0),
    ("bowup",        "scripts.upbow",          0xe167, 0.5,0, 1,0),
    ("bracketlowerlily", "brackettips.down",   0xe1a7, 0,'hy', 1,'hy'),
    ("bracketupperlily", "brackettips.up",     0xe1a6, 0,'hy', 1,'hy'),
    ("breath",       "scripts.rcomma",         0xe174, 0,0.5, 1,0.5),
    ("revbreath",    "scripts.lcomma",         0xe175, 0,0.5, 1,0.5),
    ("varbreath",    "scripts.rvarcomma",      0xe176, 0.5,0.5, 1,0.5),
    ("revvarbreath", "scripts.lvarcomma",      0xe177, 0.5,0.5, 1,0.5),
    ("caesura",      "scripts.caesura",        0xe188, 0,0.4, 1,0.4),
    ("breve",        "noteheads.sM1",          0xe124, 0,0.5, 1,0.5),
    ("clefC",        "clefs.C",                0xe193, 0,0.5, 1,0.5),
    ("clefF",        "clefs.F",                0xe195, 0,'hy', 1,'hy'),
    ("clefG",        "clefs.G",                0xe197, 0,'hy', 1,'hy'),
    ("clefTAB",      "clefs.tab",              0xe19b, 0,'hy', 1,'hy'),
    ("clefperc",     "clefs.percussion",       0xe199, 0,0.5, 1,0.5),
    ("clefCsmall",   "clefs.C_change",         0xe194, 0,0.5, 1,0.5),
    ("clefFsmall",   "clefs.F_change",         0xe196, 0,'hy', 1,'hy'),
    ("clefGsmall",   "clefs.G_change",         0xe198, 0,'hy', 1,'hy'),
    ("clefTABsmall", "clefs.tab_change",       0xe19c, 0,'hy', 1,'hy'),
    ("clefpercsmall", "clefs.percussion_change", 0xe19a, 0,0.5, 1,0.5),
    ("coda",         "scripts.coda",           0xe172, 0.5,0.5, 1,0.5),
    ("varcoda",      "scripts.varcoda",        0xe173, 0.5,0.5, 1,0.5),
    ...
    ("fermata3",     "scripts.uverylongfermata", 0xe158, 0.5,0, 1,0),
    ("fermataup",    "scripts.dfermata",       0xe153, 0.5,1, 1,1),
    ("fermata0up",   "scripts.dshortfermata",  0xe155, 0.5,1, 1,1),
    ("fermata2up",   "scripts.dlongfermata",   0xe157, 0.5,1, 1,1),
    ("fermata3up",   "scripts.dverylongfermata", 0xe159, 0.5,1, 1,1),
    ("semiflat",     "accidentals.M1",         0xe113, 0,'hy', 1,'hy'),
    ("flat",         "accidentals.M2",         0xe112, 'ox','hy', 1,'hy'),
    ("sesquiflat",   "accidentals.M3",         0xe115, 0,'hy', 1,'hy'),
    ("doubleflat",   "accidentals.M4",         0xe114, 'ox','hy', 1,'hy'),
    ("harmart",      "noteheads.s0harmonic",   0xe1c2, 0,0.5, 1,'ay'),
    ("harmnat",      "scripts.flageolet",      0xe170, 0.5,0.5, 1,0.5),
    ("flagopen",     "scripts.open",           0xe165, 0.5,'cy', 1,'cy'),
    ("flagthumb",    "scripts.thumb",          0xe15a, 0.5,'cy', 1,'cy'),
    ("headcrotchet", "noteheads.s2",           0xe127, 0,0.5, 1,'ay'),
    ("headminim",    "noteheads.s1",           0xe126, 0,0.5, 1,'ay'),
    ("legato",       "scripts.tenuto",         0xe160, 0.5,0.5, 1,0.5),
    ("portatoup",    "scripts.uportato",       0xe161, 0.5,'ly', 1,'ly'),
    ("portatodn",    "scripts.dportato",       0xe162, 0.5,'ly', 1,'ly'),
    ("mordentlower", "scripts.mordent",        0xe17e, 0.5,'cy', 1,'cy'),
    ("mordentupper", "scripts.prall",          0xe17d, 0.5,'cy', 1,'cy'),
    ("mordentupperlong", "scripts.prallprall", 0xe17f, 0.5,'cy', 1,'cy'),
    ("mordentupperlower", "scripts.prallmordent", 0xe180, 0.5,'cy', 1,'cy'),
    ("upmordentupperlong", "scripts.upprall",  0xe181, 0.5,'cy', 1,'cy'),
    ("upmordentupperlower", "scripts.upmordent", 0xe182, 0.5,'cy', 1,'cy'),
    ("mordentupperlongdown", "scripts.pralldown", 0xe183, 0.5,'cy', 1,'cy'),
    ("downmordentupperlong", "scripts.downprall", 0xe184, 0.5,'cy', 1,'cy'),
    ("downmordentupperlower", "scripts.downmordent", 0xe185, 0.5,'cy', 1,'cy'),
    ("mordentupperlongup", "scripts.prallup",  0xe186, 0.5,'cy', 1,'cy'),
    ("straightmordentupperlong", "scripts.lineprall", 0xe187, 0.5,'cy', 1,'cy'),
    ("natural",      "accidentals.0",          0xe111, 0,0.5, 1,0.5),
    ("peddot",       "pedal..",                0xe1a1, 0,'by', 1,'by'),
    ("pedP",         "pedal.P",                0xe1a2, 0,'by', 1,'by'),
    ("pedd",         "pedal.d",                0xe1a3, 0,'by', 1,'by'),
    ("pede",         "pedal.e",                0xe1a4, 0,'by', 1,'by'),
    ("pedPed",       "pedal.Ped",              0xe1a5, 0,'by', 1,'by'),
    ("pedstar",      "pedal.*",                0xe19f, 0,'by', 1,'by'),
    ("peddash",      "pedal.M",                0xe1a0, 0,'by', 1,'by'),
    ("restdbllonga", "rests.M3",               0xe104, 0,0.5, 1,0.5),
    ("restlonga",    "rests.M2",               0xe105, 0,0.5, 1,0.5),
    ("restbreve",    "rests.M1",               0xe106, 0,0, 1,0),
    ("restcrotchet", "rests.2",                0xe107, 0,0.5, 1,0.5),
    ("restcrotchetx", "rests.2classical",      0xe108, 0,0.5, 1,0.5),
    ("restdemi",     "rests.5",                0xe10b, 0,'cy', 1,'cy'),
    ("resthemi",     "rests.6",                0xe10c, 0,'cy', 1,'cy'),
    ("restquasi",    "rests.7",                0xe10d, 0,'cy', 1,'cy'),
    ("restminim",    "rests.1",                0xe101, 0,0, 1,0),
    ("restminimo",   "rests.1o",               0xe103, 0,'oy', 1,'oy'),
    ("restquaver",   "rests.3",                0xe109, 0,'cy', 1,'cy'),
    ("restsemi",     "rests.4",                0xe10a, 0,'cy', 1,'cy'),
    ("restminim",    "rests.0",                0xe100, 0,1, 1,1), # reuse restminim as semibreve rest
    ("restsemibreveo", "rests.0o",             0xe102, 0,'oy', 1,'oy'),
    ("segno",        "scripts.segno",          0xe171, 0.5,0.5, 1,0.5),
    ("semibreve",    "noteheads.s0",           0xe125, 0,0.5, 1,0.5),
    ("sforzando",    "scripts.umarcato",       0xe163, 0.5,0, 1,0),
    ("sforzandodn",  "scripts.dmarcato",       0xe164, 0.5,1, 1,1),
    ("semisharp",    "accidentals.1",          0xe10f, 0,0.5, 1,0.5),
    ...
    ("tailquaverdn", "flags.d3",               0xe18d, 'ox','oy', 1,'oy'),
    ("tailquaverup", "flags.u3",               0xe189, 'ox','oy', 1,'oy'),
    ("tailsemidn",   "flags.d4",               0xe190, 'ox','oy', 1,'oy'),
    ("tailsemiup",   "flags.u4",               0xe18a, 'ox','oy', 1,'oy'),
    ("taildemidn",   "flags.d5",               0xe191, 'ox','oy', 1,'oy'),
    ("taildemiup",   "flags.u5",               0xe18b, 'ox','oy', 1,'oy'),
    ("tailhemidn",   "flags.d6",               0xe192, 'ox','oy', 1,'oy'),
    ("tailhemiup",   "flags.u6",               0xe18c, 'ox','oy', 1,'oy'),
    ("timeCbar",     "timesig.C22",            0xe19e, 0,0.5, 1,0.5),
    ...
    ("openarrowright", "arrowheads.open.01",   0xe119, 'cx','cy', 1,'cy'),
    ("closearrowup",  "arrowheads.close.11",   0xe11f, 'cx','cy', 1,0.5),
    ("closearrowdown", "arrowheads.close.1M1", 0xe120, 'cx','cy', 1,0.5),
    ("closearrowleft", "arrowheads.close.0M1", 0xe11e, 'cx','cy', 1,'cy'),
    ("closearrowright", "arrowheads.close.01", 0xe11d, 'cx','cy', 1,'cy'),
    ("upedalheel",   "scripts.upedalheel",     0xe16c, 0.5,'cy', 1,'cy'),
    ("dpedalheel",   "scripts.dpedalheel",     0xe16d, 0.5,'cy', 1,'cy'),
    ("upedaltoe",    "scripts.upedaltoe",      0xe16e, 0.5,0, 1,0),
    ("dpedaltoe",    "scripts.dpedaltoe",      0xe16f, 0.5,1, 1,1),
    ("acc2",         "accordion.accFreebase",  0xe1aa, 0.5,0, 1,0),
    ("acc3",         "accordion.accDiscant",   0xe1a8, 0.5,0, 1,0),
    ("acc4",         "accordion.accStdbase",   0xe1ab, 0.5,0, 1,0),
    ...
    if args[0] != "-lilybrace":
        ...
        subglyphlists = [[]]
        for i in range(len(glyphlist)):
            if glyphlist[i][2] < 256:
                thissubid = 0
                thissubcode = glyphlist[i][2]
            else:
                if subcode >= 256:
                    subid = subid + 1
                    subcode = 33
                ...
                thissubcode = subcode
                subcode = subcode + 1
            subglyphlists[thissubid].append(glyphlist[i][:2] + (thissubcode,) + glyphlist[i][3:])
            glyphlist[i] = glyphlist[i][:7] + (thissubid, thissubcode) + glyphlist[i][7:]
        subids = subid + 1
