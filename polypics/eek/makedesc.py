...
flatness = 0.001
radius = 5.0
read("backdrop.dia", 0, 0)
read("backdrop.dia", 180, 0)
read("backdrop.dia", 90, 0)
read("backdrop.dia", -90, 0)
read("backdrop.dia", 0, 90)
read("backdrop.dia", 0, -90)
#read("face.dia", 0, 0, -1)
#read("face.dia", 0, 0, -1)
#read("shiny.dia", 0, 0)
...
#read("tail.dia", 0, 180)
#read("feet.dia", 0, 90)
#read("feet.dia", 0, -90, -1)
read("nosepiece.dia", 1, 0, -1)
read("nosepiece.dia", 1, 0, 1)
read("eyes.dia", -20, 20, -1)
read("eyes.dia", -20, -20, -1)
read("nose.dia", -2.5, 0, -1)
read("foot.dia", 43, 35)
read("foot.dia", 43, -35, -1)
read("ear.dia", -35, -60)
read("ear.dia", -35, 60, -1)
print "{} 0 0 0 newshape"

f = open("desc.d", "w")
f.write("desc: ")
f.write(string.join(deps.keys(), " "))
f.write("\n")
f.close()
